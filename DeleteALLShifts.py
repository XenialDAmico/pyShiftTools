...
# python3 DeleteALLShifts.py companyid=61415d24163c350007f029ae  keyid=5cc1128d-18cb-4b00-a38f-342f34729460 secret=db42d23a-9921-44a4-93df-79dbd6f80cae environment=uat siteid=617c11eed44a5d00077d4ade
...
from lib.xnu import getShifts,deleteShifts

debug = 1

scriptStart = datetime.now()

if input("Executing this script will delete all of your shifts, without prejudice. Are you SURE you want to continue? (y/n)") != "y":
    exit()
...
for  site in sitesJSON["items"]:
        ...
        if shiftsJSON["TotalCount"] > 0:
            for shift in shiftsJSON["Data"]:
                ...
                deleteShifts(xnu_conn=boconn,token=token,companyid=companyid,shiftid=shiftid)
                print("Deleted shift " + shiftid)
        else:
